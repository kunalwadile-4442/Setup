...
function App() {
  return (
    <Routes>
      ...
      {/* Public Routes */}
      <Route path={App_url.link.LOGIN} element={<Authentication />} />
      <Route path={App_url.link.REGISTER} element={<Authentication />} />
      <Route path={App_url.link.FORGOT_PASSWORD} element={<Authentication />} />
      <Route path={App_url.link.RESET_PASSWORD} element={<Authentication />} />
